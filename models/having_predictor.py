...
class HavingPredictor(BasePredictor):
    def __init__(self, *args, **kwargs):
        super(HavingPredictor, self).__init__(*args, **kwargs, name='having')
    ...
    def construct(self, N_word, hidden_dim, num_layers, gpu, use_hs):
        ...
        self.hv_out = nn.Sequential(nn.Tanh(), nn.Linear(self.hidden_dim, 2)) #for having/none
    ...
    def forward(self, q_emb_var, q_len, hs_emb_var, hs_len, col_emb_var, col_len, col_name_len, col_idx):
        ...
        return self.hv_out(H_q_cs + int(self.use_hs)*H_hs_cs + H_cs) # [batch_size, 2]
